...
Trong terminal, kết nối repository cục bộ của bạn với repository trên GitHub: git remote add origin https://github.com/TênCủaBạn/TênRepository.git
(Thay "TênCủaBạn" và "TênRepository" bằng thông tin của bạn.)

8. Đẩy mã lên GitHub
Cuối cùng, đẩy mã từ repository cục bộ lên GitHub: git push -u origin master
